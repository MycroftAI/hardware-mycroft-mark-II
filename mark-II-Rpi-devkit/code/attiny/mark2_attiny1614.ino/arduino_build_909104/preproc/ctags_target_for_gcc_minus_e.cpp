 ...
 */
# 145 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
    case 10:
      show_pattern();
      state = 255;
      break;
...
*/
# 162 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
    case 104:
      show_pattern();
      state = 255;
      break;
...
void resetBootCounts(){
  ...
  bufferI2C[0xF7] = 0;
  bufferI2C[0xF8] = 0;
  EEPROM.write(0 ,bufferI2C[0xF5] );
  EEPROM.write(0 + 1,bufferI2C[0xF6] );
  EEPROM.write(0 + 2,bufferI2C[0xF7] );
  EEPROM.write(0 + 3,bufferI2C[0xF8] );

}
unsigned int numBootsVal = 0;
void readNumBoots(){
  EEPROM.get(0, numBootsVal);

  numBootsVal += 6;

  EEPROM.put(0, numBootsVal );
 ...
 */
# 210 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
void setI2CreadOnly(){
 ...
 */
# 237 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
 ...
 */
# 258 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
...
*/
# 345 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
...
*/
# 370 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
...
void receiveEvent(int howMany) {
   ...
   */
# 468 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
  if(howMany == 1){
    reg = Wire.read();
     ...
     */
# 500 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
    if (addrStart == 0x52){
      if(bufferI2C[0x52] == 1){
