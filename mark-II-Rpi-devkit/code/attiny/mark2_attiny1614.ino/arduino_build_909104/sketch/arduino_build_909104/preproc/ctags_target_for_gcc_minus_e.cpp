...
# 6 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino" 2
...
# 52 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
/**
 ...
 */
# 138 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
    case 10:
      show_pattern();
      state = 255;
      break;
...
*/
# 155 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
    case 104:
      show_pattern();
      state = 255;
      break;
...
void readNumBoots(){
  bufferI2C[0xF5] = EEPROM.read(0);
  bufferI2C[0xF6] = EEPROM.read(0 + 1);
  bufferI2C[0xF7] = EEPROM.read(0 + 2);
  bufferI2C[0xF8] = EEPROM.read(0 + 3);
  long numBootsVal = 0;
  ...
  EEPROM.write(0 , numBootsVal & 0xFF);
  EEPROM.write(0 + 1,(numBootsVal >> 8) & 0xFF);
  EEPROM.write(0 + 2,(numBootsVal >> 16) & 0xFF);
  EEPROM.write(0 + 3,(numBootsVal >> 32) & 0xFF);
 ...
 */
# 201 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
void setI2CreadOnly(){
 ...
 */
# 228 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
 ...
 */
# 249 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
...
*/
# 336 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
...
*/
# 361 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
...
*/
# 398 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
 ...
 **/
# 450 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
void receiveEvent(int howMany) {
   ...
   */
# 459 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
  if(howMany == 1){
    reg = Wire.read();
    Serial.print(reg);
  }
     ...
     */
# 490 "C:\\Dropbox\\Crashspace\\Mycroft\\programming\\mark2_attiny1614.ino\\mark2_attiny1614.ino.ino"
    if (addrStart == 0x52){
      if(bufferI2C[0x52] == 1){
        digitalWrite(2 /*PA6*/, 1);
      }
      else{
        digitalWrite(2 /*PA6*/, 0);
      }
    }
    nextState = true;
  }
